...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <div className=" bg-cyan-800 backdrop-blur-xl border border-slate-700 p-8 sm:p-10 rounded-3xl w-full max-w-md relative z-10 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
        ...
        <div className="flex flex-col items-center justify-center mb-6 relative">
          <div className="relative flex items-center justify-center">
            ...
            {/* Core Icon */}
            <div className="w-14 h-14 rounded-full flex items-center justify-center relative z-10 shadow-[inset_0_0_15px_rgba(168,85,247,0.3)]">
